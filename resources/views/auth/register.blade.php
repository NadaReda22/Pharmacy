...
@endif
        ...
        <div class="card shadow p-4">
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select name="role" id="role" class="form-control" required onchange="toggleLicense()">
                        <option value="">اختر نوع الحساب</option>
                        <option value="client">عميل</option>
                        <option value="vendor">صاحب صيدلية</option>
                    </select>
                </div>

                <div class="mb-3" id="license_field" style="display:none;">
                    <label for="license_file">رخصة الصيدلية</label>
                    <input type="file" name="license_file" class="form-control" accept=".png,.jpg,.jpeg,.pdf">
                </div>
    ...
    <script>
        function toggleLicense() {
            ...
            licenseField.style.display = role === 'vendor' ? 'block' : 'none';
        }
    </script>
</body>
</html>
